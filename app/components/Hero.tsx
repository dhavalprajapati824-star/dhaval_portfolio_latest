      ...
      <motion.div style={{
        ...
        <motion.p
          ...
          style={{
            ...
            lineHeight: 1.7, marginBottom: "3rem", fontStyle: "italic",
          }}
        >
          and I'm a <strong style={{ color: "var(--text)", fontStyle: "normal" }}>Quality Analyst</strong> with 8+ years ensuring product excellence across software, mobile apps, and web technologies.
        </motion.p>
        ...
        >
          {[["8+", "Years Experience"], ["2", "Companies"], ["13+", "Skills & Tools"], ["100%", "Commitment"]].map(([v, l]) => (
            <div key={l}>
              <div style={{
                fontFamily: "var(--font-display)",
