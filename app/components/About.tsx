        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="about-grid">
          ...
          >
            ...
            <div style={{
              ...
              {/* ── Photo ── place photo.png inside your /public folder ── */}
              <Image
                src="/photo.png"
              ...
              {/* Subtle gradient overlay so badge stays readable */}
              <div style={{
                position: "absolute", bottom: 0, left: 0, right: 0, height: "35%",
                background: "linear-gradient(to top, rgba(7,7,15,0.85) 0%, transparent 100%)",
                pointerEvents: "none",
              }} />
